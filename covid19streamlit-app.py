...
... import urllib
... 
... URL = "https://data.cdc.gov/resource/vbim-akqf.json?$query=SELECT%0A%20%20%60cdc_case_earliest_dt%60%2C%0A%20%20%60cdc_report_dt%60%2C%0A%20%20%60pos_spec_dt%60%2C%0A%20%20%60onset_dt%60%2C%0A%20%20%60current_status%60%2C%0A%20%20%60sex%60%2C%0A%20%20%60age_group%60%2C%0A%20%20%60race_ethnicity_combined%60%2C%0A%20%20%60hosp_yn%60%2C%0A%20%20%60icu_yn%60%2C%0A%20%20%60death_yn%60%2C%0A%20%20%60medcond_yn%60"
...
df['Race and ethnicity (combined)'] = df['Race and ethnicity (combined)'].apply(lambda x: 'Unknown' if x == 'Missing' else x)
